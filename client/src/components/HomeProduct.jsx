...
const HomeProduct = () => {
  return (
    <section className="relative bg-[#f6e8ee]">
      {/* Top Background Shape */}
      <div className="absolute top-0 left-0 w-full h-full bg-[#e0c9d0] clip-custom z-0"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:row-span-2">
            <img
              ...
              alt="Saree Model"
              className="w-full h-110 object-fill shadow-md rounded-l-2xl"
            />
          </div>

          {/* Right side grid images */}
          <div className="grid grid-cols-2 gap-6 md:col-span-2 mt-5">
            <img
              src="/product-1-img.jpg"
              alt="Sarees"
              className="w-full h-40 md:h-48 object-cover  shadow-md"
            />
            <img

    ...
    <section className="py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-[#722d2d] text-[#fdecec] p-8 md:p-12 rounded-lg md:rounded-tl-[8rem] md:rounded-br-[8rem] shadow-lg">
          <h1 className="flex text-2xl md:text-3xl lg:text-4xl font-serif font-bold mb-6 justify-center text-[#ff7a7a]">Terms &amp; Conditions</h1>
          ...
          <p className="text-sm mb-6">Welcome to <span className="font-semibold text-[#fff694]">"Antariksh Silk"</span>. By accessing or using our website, you agree to the following terms and conditions. Please read them carefully.</p>

    ...
    <section className="py-6 sm:py-8 md:py-12 lg:py-16 xl:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-6 sm:mb-8 md:mb-10 lg:mb-12">
          ...
          <h2 className="mt-2 sm:mt-3 text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold text-[#3a2233] leading-tight font-playfair">
            What our Customers says...
          </h2>
        </div>

        <div className="relative w-full bg-[#550000] py-10 text-white rounded-lg sm:rounded-xl md:rounded-2xl md:rounded-tr-[4rem] md:rounded-br-[4rem] md:rounded-bl-[4rem] lg:rounded-tr-[2rem] lg:rounded-br-[2rem] lg:rounded-bl-[2rem] xl:rounded-tr-[8rem] xl:rounded-br-[8rem] xl:rounded-bl-[8rem] overflow-hidden lg:py-20">
          {/* Decorative quotation marks */}
          <FaQuoteLeft className="absolute left-12 top-50 lg:top-25 text-2xl md:text-7xl lg:text-4xl lg:ml-140" />
          <FaQuoteRight className="absolute right-4 bottom-6 text-2xl md:text-5xl lg:text-4xl lg:bottom-30 lg:mr-10" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-12 items-center lg:items-start p-6 sm:p-8 md:p-10 lg:p-12 xl:p-16">
            ...
            <div className="flex items-center justify-center lg:justify-start order-1 lg:order-1">
              <img 
                ...
                className="w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 lg:w-56 lg:ml-30 lg:h-56 xl:w-64 xl:h-64 rounded-full object-cover ring-2 sm:ring-4 ring-white shadow-lg sm:shadow-2xl" 
              />
            </div>

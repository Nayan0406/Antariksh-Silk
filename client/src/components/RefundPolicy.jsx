    ...
    <section className="py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-[#702a2a] text-[#fdecec] p-8 md:p-12 rounded-lg md:rounded-tl-[6rem] md:rounded-br-[6rem] shadow-lg">
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-serif font-bold text-center mb-6 text-[#ff7a7a]">Return &amp; Refund Policy</h1>
          ...
          <p className="text-sm mb-6">We want you to love your saree! If you are not completely satisfied, you may request a return or exchange under the following conditions:</p>
          ...
          <div className="space-y-4 text-sm leading-relaxed">
            ...
            <div className="pt-4">
              <p className="text-sm">For assistance, please contact us at <span className="font-medium">support@[yourbrand].com</span> with your order details.</p>
            </div>
          </div>
        </div>
      </div>

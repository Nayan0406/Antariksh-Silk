    ...
    <section className="py-6 sm:py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-[#722d2d] text-[#fdecec] p-6 sm:p-8 md:p-12 rounded-lg md:rounded-tl-[8rem] md:rounded-br-[8rem] shadow-lg max-w-3xl md:max-w-5xl lg:max-w-7xl mx-auto">
          <h1 className="flex text-xl sm:text-2xl md:text-3xl lg:text-4xl font-serif font-bold mb-6 justify-center text-[#ff7a7a]">Privacy Policy</h1>
          ...
          <p className="text-sm md:text-base mb-6">At <span className="font-semibold text-[#fff694]">"Antariksh Silk",</span> we value your privacy and are committed to protecting your personal information.</p>
          ...
          <div className="space-y-6 text-sm md:text-base leading-relaxed">
            <div>
              ...
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li>Payment details (processed securely through trusted gateways).</li>
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li>Your payment details are encrypted and handled by secure payment gateways.</li>
            ...
            <div>
              ...
              <p className="pl-5">Our website may use cookies to enhance your browsing experience and show personalized offers.</p>
            </div>

            <div>
              <h3 className="font-semibold mb-2">5. Third-Party Services</h3>
              <p className="pl-5">We may share limited data with delivery partners or payment processors only for completing your order.</p>
            </div>

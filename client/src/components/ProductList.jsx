  ...
  <div className="relative bg-[#fbf0df] md:rounded-tl-[10rem] md:rounded-br-[10rem] p-4 md:p-6">
          <div className="overflow-x-auto hide-scrollbar py-4">
            <div className="flex gap-6 items-stretch snap-x snap-mandatory">
              {/* Card 1 */}
              <article className="snap-center flex-shrink-0 w-70 sm:w-74 md:w-70 bg-white rounded-xl shadow-md overflow-hidden flex flex-col">
              ...
              {/* Card 2 */}
              <article className="snap-center flex-shrink-0 w-70 sm:w-64 md:w-70 bg-white rounded-xl shadow-md overflow-hidden flex flex-col">
